...
export default function CreateTables() {
  ...
  return (
    <div className='container'>
      <h2 className='d-flex justify-content-center my-3' style={{fontSize: '40px'}}>Create Table</h2>
      <ErrorAlert error={tableErrors} />
      <div className='d-flex justify-content-center'>
        <form onSubmit={handleSubmit} className='row'>
          <label htmlFor='table_name' className='form-label' style={{ fontSize: '20px' }}>
            Table Name
          </label>
          <input
            name='table_name'
          ...
          />
          <label htmlFor='capacity' className='form-label' style={{ fontSize: '20px' }}>
            Capacity
          </label>
          <input
            name='capacity'
