...
export default function ReservationForm({ handleSubmit, reservation, setReservation }) {
  ...
  return (
    <div className='container'>
      <form onSubmit={submitHandler} className='row'>
        ...
        <div className='col-6'>
          <button className='btn btn-secondary my-3' onClick={handleCancel} style={{width: '100%'}}>Cancel</button>
        </div>
        <div className='col-6'>
