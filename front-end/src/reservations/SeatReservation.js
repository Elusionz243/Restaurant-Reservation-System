  ...
  return (
    <div className='row'>
      <div className='col-12 d-flex justify-content-center my-3'>
        <h2><strong>Seat Reservation</strong></h2>
      </div>
      ...
      <div className='col-12 d-flex justify-content-center'>
        <form onSubmit={handleSubmit} className='card p-3'>
          <div className='col-12'>
            <label htmlFor='table_id' className='form-label'>Select a table to seat reservation</label>
            <select
              name='table_id'
              ...
              className='col-12 mb-3 form-control'>
              {
                ...
                <option key={index} value={table_id}>{table_name} - {capacity}</option>)
              }
            </select>
          </div>
          <div className='col-12 d-flex justify-content-center'>
